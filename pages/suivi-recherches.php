        ...
        <div class="max-w-5xl mx-auto flex flex-col gap-6">
            <div class="flex justify-between items-center bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                <div>
                    ...
                    <p class="text-xs text-slate-400">Déclarez vos entretiens et valisez vos offres de stage.</p>
                </div>
            </div>
                    ...
                    <div class="bg-white p-5 rounded-xl border border-slate-200 shadow-sm flex flex-col justify-between">
                        <div>
                            ...
                            <?php elseif ($r['statut_candidature'] === 'attente_validation'): ?>
                                <span class="bg-amber-100 text-amber-800 px-3 py-1 rounded-full text-xs font-bold">Résumé envoyé (En attente Responsable)</span>
                            ...
                            <?php elseif ($r['statut_candidature'] === 'accepte'): ?>
                                ...
                                <p class="text-xs text-slate-500">Le responsable des stages va bientôt vous affilier un tuteur.</p>
