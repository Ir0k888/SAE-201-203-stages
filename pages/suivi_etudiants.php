                ...
                <div class="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                    ...
                    <?php if (!$etu['id_soutenance']): ?>
                        <form action="../actions/proposer_soutenance_action.php" method="POST" class="bg-slate-50 p-4 rounded-lg border border-slate-200 text-sm">
                            ...
                            <button type="submit" class="w-full bg-indigo-600 text-white font-bold py-2 rounded-md hover:bg-indigo-700">Soumettre à l'Admin</button>
                        </form>
                    <?php else: ?>
                        <div class="bg-slate-50 p-4 rounded-lg border border-slate-200">
                            ...
                            <?php if ($etu['statut_soutenance'] === 'en_attente'): ?>
                                <span class="bg-amber-100 text-amber-800 px-3 py-1 rounded-full text-xs font-bold">En attente de l'Admin</span>
                            <?php else: ?>
